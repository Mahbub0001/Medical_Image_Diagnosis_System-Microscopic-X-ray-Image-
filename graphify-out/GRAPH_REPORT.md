...
## Corpus Check
- 60 files · ~505,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 416 nodes · 577 edges · 33 communities (30 shown, 3 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c66cf152`
...
Cohesion: 0.14
Nodes (13): 📌 1. Executive Summary & Core Mission, 🏗️ 2. Microservices Architecture & Cloud Stack, 🧠 3. Machine Learning Models & Deep Pipelines, 🔍 4. Explainable AI (Grad-CAM Visualizations), 📄 5. Summary Matrix of System Core Features, A. Frontend Presentation Layer, 🛡️ A. Image Domain Router & Quality Validator (`routers.py`), B. Backend API Gateway Layer (+5 more)
...
- **Why does `run_ensemble()` connect `inference.py` to `prediction.py`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `BloodDetect AI — Medical Image Diagnosis System` connect `BloodDetect AI — Medical Image Diagnosis System` to `11.2 Pages & Features`, `5.1 API Endpoints`?**
