...
export default function LungXrayPage() {
  ...
  useEffect(() => {
    ...
    if (loading) {
      const messages = [
        "Uploading chest radiograph to cloud server...",
        "Preprocessing pixel matrix dimensions...",
        "Evaluating lung lung fields via ResNet-18 model...",
        "Identifying potential opacity or lesions...",
        "Synthesizing Grad-CAM heatmap visualization...",
        "Generating diagnostic report PDF..."
      ];
      let i = 0;
  ...
  const getBarColor = (className) => {
    ...
    return "var(--warning)"; // Tuberculosis
  };
  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <p>Analyze chest radiographs (X-rays) for signs of Pneumonia, Tuberculosis, or Normal lungs.</p>
      </div>
      ...
      <div className="card">
        <form onSubmit={onSubmit} className="upload-form">
          ...
          <div style={{ display: "grid", gap: "8px" }}>
            <span style={{ fontWeight: 600, fontSize: "0.9rem", color: "#cbd5e1" }}>Chest X-Ray Scan</span>
            ...
            {!file ? (
              <div 
                ...
                onDrop={handleDrop}
                onClick={() => document.getElementById("file-select-xray").click()}
              >
                ...
                <div>
                  <p style={{ margin: "0 0 4px 0", fontWeight: 700, color: "#ffffff" }}>Drag & drop chest radiograph here</p>
