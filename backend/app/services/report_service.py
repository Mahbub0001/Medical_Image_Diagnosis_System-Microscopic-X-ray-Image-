...
def _make_page_decorator(report_id: str, report_type: str = "Diagnostic Report"):
    ...
    def _on_page(cv: pdfcanvas.Canvas, doc):
        ...
        cv.drawString(20 * mm, 9 * mm,
                      "⚠ AI-generated — For academic purposes only. Not a substitute for professional medical advice.")
...
def _disclaimer_block(styles):
    return [
        ...
        Spacer(1, 3 * mm),
        Paragraph(
            "DISCLAIMER: This document is generated by an AI-based prototype system "
            "and is intended strictly for academic and educational research purposes. "
            "It must NOT be used as a substitute for professional medical diagnosis, "
            "clinical judgement, or treatment decisions. Always consult a qualified "
            "healthcare professional for any medical concerns.",
            styles["disclaimer"],
        ),
        Paragraph(
            "BioLens AI Platform  |  Hematology Analysis Module  |  Confidential",
            ParagraphStyle("DF2", fontSize=7, fontName="Helvetica-Bold",
